export const NotificationAlertIcon = () => {
  return (
    <svg data-cy="modal-information-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="#00A790" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
...
export const FilterRoundIcon = () => {
  return (
    <svg data-cy="todo-sort-button" className="cursor-pointer" width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const FilterIcon = () => {
  return (
    <svg data-cy="sort-selection-icon" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 16L4 16 10 22 10 19 10 16 10 2 8 2zM14 5L14 8 14 22 16 22 16 8 20 8 14 2z"></path>
    </svg>
  )
}

export const FilterZAIcon = () => {
  return (
    <svg data-cy="sort-selection-icon" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
